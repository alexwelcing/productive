  ...
  <div>
    ...
    <section class="tv-content-container tv-section-padding">
      <div class="container">
        <div class="row">
          <div
            class="col-xl-8 col-lg-8 col-md-12 order-xl-1 order-lg-1 order-2"
          >
          ...
          <div
            class="col-xl-4 col-lg-4 col-md-12 order-1 tv-right-sidebar"
            id="sidebar"
          >
            <div class="tv-sidebar-container">
              <div class="tv-widget tv-widget-category">
                ...
                <div class="tv-widget-category-box">
                  ...
                  <div class="view-all">
                    <nuxt-link to="/tag" class="view-all-btn"
...
export default {
  ...
  methods: {
    ...
    getTags: function() {
      axios
        .get(
          HOST_URL + "/tags/?key=" + API_KEY + "&limit=10&include=count.posts"
        )
        .then(response => {
